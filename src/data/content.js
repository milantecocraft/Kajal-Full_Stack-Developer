export const profile = {
  name: 'Kajalben Gondaliya',
  shortName: 'Kajal Gondaliya',
  pronouns: 'She/Her',
  ...
  linkedin: 'https://www.linkedin.com/in/kajalgondaliya/',
  github: 'https://github.com/kajalgondaliya',
  upwork: 'https://www.upwork.com/freelancers/kajalbengondaliya',
}
...
export const stats = [
  ...
  { value: '25%', label: 'Faster operations with AI workflows' },
  { value: '40%', label: 'Fewer production bug regressions' },
...
export const partnerPoints = [
  ...
  },
  {
    ...
    text: 'Rigorous TDD, automated CI/CD guardrails, and strong API contracts that structurally reduce production bug regressions.',
  },
]
...
export const services = [
  ...
  },
  {
    ...
    text: 'iOS and Android apps that put your product in every pocket, built with the same engineering rigor as the platform.',
  },
  {
    icon: '🔌',
...
export const skillGroups = [
  ...
  {
    label: 'Mobile',
    skills: ['iOS Development', 'Android Development', 'Cross-Platform Apps'],
  },
  {
    label: 'AI & DevOps',
    skills: ['AI Chatbots', 'Workflow Automation', 'CI/CD', 'TDD', 'Git'],
  },
]

export const topSkills = ['React.js', 'Next.js', 'JavaScript', 'HTML', 'Node.js']
...
export const projects = [
  ...
  {
    title: 'Legalspace',
    url: 'https://legalspace.ai/',
    image: '/projects/legalspace.webp',
    category: 'AI & SaaS',
  ...
  {
    title: 'Flirtbees',
    url: 'https://flirtbees.com/',
    image: '/projects/flirtbees.webp',
    category: 'Platforms & Tools',
  ...
  },
  {
    ...
    image: '/projects/tropicalsky.webp',
  ...
  },
  {
    ...
    url: 'https://www.starsofboston.com/',
    image: '/projects/starsofboston.webp',
    category: 'Travel & Stays',
    role: 'Booking site & property management tooling',
    outcome: '~30% more direct bookings',
    text: 'Beautifully furnished, professionally managed short-term and extended-stay accommodations across Greater Boston.',
  ...
  },
  {
    ...
    image: '/projects/mizzenandmain.webp',
    category: 'E-commerce & Fashion',
  ...
  {
    title: 'Wana Brands',
    url: 'https://www.wanabrands.com/',
    image: '/projects/wanabrands.webp',
    category: 'E-commerce & Fashion',
